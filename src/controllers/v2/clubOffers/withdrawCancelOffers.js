...
module.exports = async (request) => {
    if (request.user.type == 'individual') {
        return serializeHttpResponse(400, {
            message: `Operation denied. ${request.user.type} cannot cancel offer`
        });
    }
    ...
    if (clubOffer.createdBy != childProfileId) {
        return serializeHttpResponse(400, {
            message: 'Operation denied. Club offer not created by you.'
        });
    }
