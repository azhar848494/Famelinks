  ...
  return hiringprofile.aggregate([
    ...
    },
    {
      $project: {
        ...
        profileImage: '$profile.profileImageX50',
        profileImageType: '$profile.profileImageType',
        profile: {
          name: "$profile.profileJoblinks.name",
          profileImage: "$profile.profileJoblinks.profileImageX50",
        ...
        pipeline: [
          ...
          },
          {
            $lookup: {
              ...
              pipeline: [
                ...
                // { $project: { trendsWon: 1, ambassador: 1, username: 1, profileImage: '$profileImageX50', profileImageType: 1, followersCount: 1, dob: 1, profileFamelinks: 1 } },
                {
                  $set: {
                    ambassador: {
                      $cond: [
          ...
          },
          {
            $set: {
              MasterProfile: {
                ...
                profileImage: "$masterProfile.profileImageX50",
          ...
          { $addFields: { chatId: "$chatId._id" } },
          {
            $group: {
              ...
              profileImage: { $first: { $first: "$profile.profileImageX50" } },
              profileImageType: {
