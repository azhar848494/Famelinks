  ...
  return UserDB.findOne(
    { _id: userId },
    {
      ...
      profileJoblinks: {
        ...
        profileImageX50: '$profileJoblinks.profileImageX50',
        profileImageX300: '$profileJoblinks.profileImageX300',
      ...
      profileStorelinks: {
        ...
        profileImageX50: '$profileStorelinks.profileImageX50',
        profileImageX300: '$profileStorelinks.profileImageX300',
      ...
      profileCollablinks: {
        ...
        profileImageX50: '$profileCollablinks.profileImageX50',
        profileImageX300: '$profileCollablinks.profileImageX300',
...
exports.getFollowers = (userId, page, selfUserId, search) => {
  let obj = {};
  if (search) {
    obj = {
      $and: [
...
exports.getFollowees = (userId, page, selfUserId, type, search) => {
  switch (type) {
    case 'all':
      let obj = {};
      if (search) {
      ...
      return FollowerDB.aggregate([
        { $match: { followerId: ObjectId(userId), acceptedDate: { $ne: null } } },
        { $addFields: { followStatus: 0 } },
        {
          $lookup: {
            from: "followers",
...
exports.getFollowSuggestions = (userId, page, search) => {
  let obj = {};
  if (search) {
    obj = {
      $and: [
...
exports.getOtherProfileJoblinks = (
  ...
  if (profileType == "individual" || profileType == "agency") {
    return UserDB.aggregate([
      ...
      { $set: { totalJobs: { $first: "$totalJobs.totalCount" } } },
      {
        $lookup: {
          from: "jobs",
          let: { createdBy: userId },
      ...
      { $set: { openJobsCount: { $first: "$openJobCount.totalCount" } } },
      {
        $lookup: {
          from: "jobs",
          let: { createdBy: userId },
